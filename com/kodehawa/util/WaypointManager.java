...
public class WaypointManager {
	...
	public WaypointManager( Minecraft mc ) {
		directory = new File( mc.mcDataDir, "/colony/waypoints.colony" );
		if ( !directory.exists( ) ) {
			directory.mkdirs( );
		}
	...
	public void saveWaypoints( )
	{
		...
		else
		{
			try
			{
				...
				var2.flush( );
				var2.close( );
				ConsoleHelper.addMessage( "\u00a7E[Colony Waypoint Manager] Waypoints saved!" );
			} catch ( Exception var5 )
			{
				ConsoleHelper.addMessage( "\u00a7E[Colony Waypoint Manager] Error Saving Waypoints" );
