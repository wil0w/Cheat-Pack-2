...
public class ContainerBrewing extends Container
{
    public InventoryBrewing invBrew;

    public ContainerBrewing(IInventory iinventory)
    {
        invBrew = new InventoryBrewing();
