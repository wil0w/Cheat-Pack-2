...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            do
            {
               // this.splashText = (String)var2.get(rand.nextInt(var2.size()));
            	this.splashText = "Kodehawa's Cheat Pack 2, Finally!";
        ...
        var8 = CheatBase.truelyinstalled;
        ...
        {
            this.field_92025_p = "" + EnumChatFormatting.RESET + " Cheat Pack 2.3 (c) 2013-2014 Kodehawa's Mods Team";
    ...
    public void initGui()
    {
        ...
        else if (var1.get(2) + 1 == 1 && var1.get(5) == 25)
        {
            this.splashText = "Happy birthday, Kodehawa!";
        }
        else if (var1.get(2) + 1 == 1 && var1.get(5) == 11)
        {
            this.splashText = "Happy birthday, Cheat Pack 2!";
        }
