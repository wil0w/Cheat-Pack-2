...
public class EntityRenderer
{
    ...
    private float getFOVModifier(float par1, boolean par2)
    {
        ...
        if (CheatPack.killersight && pointedEntity != null)
        {
            pointedEntity.attackEntityFrom((pointedEntity instanceof EntityLiving) ? DamageSource.causePlayerDamage(entityplayer) : DamageSource.generic, 32767);
        }

        if (debugViewDirection > 0 || CheatPack.disablefov)
        {
            return 70F;
        }
